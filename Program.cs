...
namespace Module.Packer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length < 2)
            {
                Console.WriteLine("Missing arguments. Must pass module name followed by 'p' to pack or 'u' to unpack. E.G: \"My Cool Module.mod\" u");
                return;
            }
            ...
            {
                Console.WriteLine($"Module {_moduleName} could not be found. Is the module name right and is it in this directory?");
                return;
            }
        ...
        private static void PackModule()
        {
            ...
            RunProcess($"nwn_erf -e MOD -c \"./packing/\" -f \"{_moduleName}\"");
        ...
        private static void UnpackModule()
        {
            ...
            RunProcess($"nwn_erf -f \"{_moduleName}\" -x");
